    ...
    class IniWriter
    {
        ...
        public function writeToFile($filename, array $config, $header = '')
        {
            ...
            if (!file_put_contents($filename, $ini)) {
                throw new ConfigurationException(sprintf('Impossible to write to file %s', $filename));
            }
        }
        ...
        public function writeToString(array $config, $header = '')
        {
            ...
            foreach ($sectionNames as $sectionName) {
                ...
                if (! is_array($section)) {
                    throw new ConfigurationException(sprintf("Section \"%s\" doesn't contain an array of values", $sectionName));
                }
